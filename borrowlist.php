...
<nav class="navbar navbar-expand-md bg-dark navbar-dark">
  ...
  <div class="collapse navbar-collapse" id="collapsibleNavbar">
    <ul class="navbar-nav">
      ...
      <li class="nav-item">
        <a class="nav-link active" href="http://localhost/project/borrowlist.php">Borrow List</a>
      </li>
      <li class="nav-item">
...
<section class="row">
  ...
  <section class="col-xs-12 col-sm-12 col-md-12">
      <center><h3>Borrow List</h3></center>
...
<tbody id="myTable">
  ...
  $sql = "SELECT `borrowID`, `m_id`, `m_name`, `m_address`, `m_contract`, `b_id`, `b_name`, `borrow_date` FROM `borrow`";
