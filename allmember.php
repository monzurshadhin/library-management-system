...
<nav class="navbar navbar-expand-md bg-dark navbar-dark">
  ...
  <div class="collapse navbar-collapse" id="collapsibleNavbar">
    <ul class="navbar-nav">
      ...
      <li class="nav-item">
        <a class="nav-link active" href="http://localhost/project/allmember.php">All members</a>
      </li>
      <li class="nav-item">
...
<tbody id="myTable">
    ...
    if (mysqli_num_rows($result) > 0) {
      ...
      while ($row = mysqli_fetch_assoc($result)) {
        ...
        echo '<td>
        <a href="delete.php?id='.$row['m_id'].'" style="color:red;text-decoration: none;" class="fa fa-trash fa-2x"></a>
        </td>';
        echo '<td>
        <a href="update.php?id='.$row['m_id'].'" style="color:green;text-decoration: none;" class="fa fa-edit fa-2x"</i></a>
