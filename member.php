  ...
  <div class="collapse navbar-collapse" id="collapsibleNavbar">
    <ul class="navbar-nav">
     ...
     <a class="nav-link" href="http://localhost/project/Book.php">Add Books</a>
      ...
      <li class="nav-item">
        <a class="nav-link active" href="http://localhost/project/member.php">Add Members</a>
      </li>
    ...
    <section class="container-fluid">
      ...
      <section class="row">
        ...
        <section class="col-xs-8 col-sm-8 col-md-8">
          <form class="form-container" action="memberinsert.php" method="post">
                 ...
                 <div class="form-group">
                   ...
                   <input type="date" class="form-control" id="bdate" placeholder="Enter Birth Date" name="bdate">
                 </div>
                 <div class="form-group">
                   <label for="gender">Gender</label>
                   <br>
                 <select id="gender" name="gender"style="padding:6px;border-radius: 4px;">
               ...
               <div class="form-group">
                 ...
                 <br>
               <select id="mtype" name="mtype"style="padding:6px;border-radius: 4px;">
