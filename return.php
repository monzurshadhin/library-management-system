...
<nav class="navbar navbar-expand-md bg-dark navbar-dark">
  ...
  <div class="collapse navbar-collapse" id="collapsibleNavbar">
    <ul class="navbar-nav">
      ...
      <li class="nav-item">
        <a class="nav-link active" href="http://localhost/project/return.php">Return Books</a>
      </li>
      <li class="nav-item">
...
<section class="container-fluid">
  ...
  <section class="row">
    ...
    <section class="col-xs-8 col-sm-8 col-md-8">
      <form class="form-container" action="return_done.php" method="post">
             <div class="form-group">
               <center><h3>Book Return</h3></center>
               <br>
               <br>
           ...
           <div class="form-group">
             ...
             <button type="submit" onclick="myFunction()" class="btn btn-primary">Return</button>
